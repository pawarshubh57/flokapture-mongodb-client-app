    ...
    a.extend(a.jqx._jqxCheckBox.prototype,
        {
            ...
            render: function() {
                ...
                var d = this;
                this.setSize();
                this.propertyChangeMap.width = function(h, j, i, k) { d.setSize() };
                this.propertyChangeMap.height = function(h, j, i, k) { d.setSize() };
                ...
                if (this.boxSize != "13px") {
                    this.checkbox = a('<div><div style="width: ' +
                        g +
                        "; height: " +
                        g +
            ...
            uncheck: function() {
                ...
                if (a.jqx.browser.msie || this.animationHideDelay == 0) {
                    ...
                    this.checkMark.stop().animate({ opacity: 0 },
