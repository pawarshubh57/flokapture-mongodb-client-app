    ...
    a.extend(a.jqx._jqxDropDownList.prototype,
        {
            ...
            render: function() {
                ...
                q.addHandler(q.dropdownlistWrapper, "selectstart", function() { return false });
                ...
                var n = q.toThemeProperty("jqx-widget") +
                    " " +
                    q.toThemeProperty("jqx-dropdownlist-state-normal") +
                    " " +
                    q.toThemeProperty("jqx-rc-all") +
                    " " +
                    q.toThemeProperty("jqx-fill-state-normal");
                ...
                try {
                    ...
                    q.addHandler(q.listBoxContainer,
                        "bindingComplete",
                        function(e) {
                            if (!q.listBox) {
            ...
            _setSize: function() {
                ...
                a.jqx.utilities.resize(this.host, function() { d() }, false, this._checkForHiddenParent)
            },
            isOpened: function() {
                var c = this;
            ...
            _updateHandlers: function() {
                ...
                if (this.host.parents()) {
                    this.addHandler(this.host.parents(),
                ...
                this.addHandler(this.listBoxContainer,
                    ...
                    function(e) {
                        ...
                        c._raiseEvent(5,
                            { label: e.args.label, value: e.args.value, checked: e.args.checked, item: e.args.item })
                    });
                this.addHandler(this.listBoxContainer,
                    "select",
                    function(e) {
                ...
                if (this.listBox) {
                    if (this.listBox.content) {
                        this.addHandler(this.listBox.content,
                            "click",
                            function(e) {
                                if (!c.disabled) {
                ...
                this.addHandler(this._firstDiv,
                    "focus",
                    function(e) {
                        if (c.renderMode !== "simple") {
                            c.host.addClass(c.toThemeProperty("jqx-dropdownlist-state-focus"));
            ...
            renderSelection: function() {
                ...
                j.removeClass();
                if (this.selectionRenderer) {
                    a.jqx.utilities.html(this.dropdownlistContent,
                    ...
                    if (this.checkboxes) {
                        ...
                        for (var o = 0; o < g.length; o++) {
                            if (g[o].label === "Select All") continue;
            ...
            showListBox: function() {
                ...
                if (this.enableBrowserBoundsDetection) {
                    var i = this.testOffset(d,
                        { left: parseInt(this.container.css("left")), top: parseInt(k) },
            ...
            clearFilter: function() { this.listBox.clearFilter() },
