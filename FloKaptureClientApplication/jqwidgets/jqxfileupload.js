...
(function (a) {
    ...
    a.extend(a.jqx._jqxFileUpload.prototype, {
        defineInstance: function () {
            var b = {
                width: null, height: "auto", uploadUrl: "", fileInputName: "", autoUpload: false,
                multipleFilesUpload: true, accept: null, browseTemplate: "", uploadTemplate: "",
                cancelTemplate: "", localization: null, renderFiles: null, disabled: false, rtl: false,
        ...
        cancelAll: function () {
            ...
            if (c._fileRows.length > 0) {
                ...
                setTimeout(function () { c._browseButton.css("margin-bottom", 0) }, 400);
        ...
        _addFileRow: function (f, b, e, d) {
            ...
            var c = {
                fileRow: l, fileNameContainer: g, fileName: f, uploadFile: n,
                cancelFile: j, loadingElement: m, form: b, fileInput: e, index: h._fileRows.length
            };
        ...
        _removeSingleFileRow: function (c) {
            ...
            if (d._fileRows.length === 0) {
                setTimeout(function () { d._browseButton.css("margin-bottom", 0) }, 400);
                d._hideButtons(true)
            } else {
