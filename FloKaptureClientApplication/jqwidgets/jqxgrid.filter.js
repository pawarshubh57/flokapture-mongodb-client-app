    ...
    a.extend(a.jqx._jqxGrid.prototype,
        {
                    ...
                    if (g.createfilterwidget && g.filtertype == "custom") {
                        ...
                        if (g.filterable) {
                            ...
                            case"input":
                                ...
                                a(k.find(".jqx-dropdownlist-state-normal"))
                                    .jqxDropDownList({ theme: l.theme, disabled: l.disabled });
                                break;
                            case"date":
                            case"range":
                                if (this.host.jqxDateTimeInput) {
                                    a(k.children()[0])
                                        .jqxDateTimeInput({ theme: l.theme, disabled: l.disabled, width: c - 10 })
                                } else {
                                    d(this, k)
                                }
                                break;
                            ...
                            case"checkedlist":
                                if (this.host.jqxDropDownList) {
                                    a(k.children()[0])
                                        .jqxDropDownList({ theme: l.theme, disabled: l.disabled, width: c - 10 })
                                } else {
                                    d(this, k)
                                }
                                break;
                        ...
                        case"input":
                            ...
                            if (this.host.jqxDropDownList) {
                                ...
                                if (g == 0) {
                                    ...
                                    var h = n.getoperatorsbyfiltertype(f.filtertype == "number"
                                        ? "numberfilter"
                                        : "stringfilter");
                ...
                for (var h = 0; h < o; h++) {
                    ...
                    if (k) {
                        if (e.filtertype == "custom" && e.createfilterwidget) {
                            var i = function() { n._applyfilterfromfilterrow() };
            ...
            _addfilterwidget: function(C, d, A) {
                ...
                var g = function (I, J) {
                    ...
                    f.focus(function() {
                        ...
                        setTimeout(function() { I.content[0].scrollLeft = 0; }, 10);
                        I.focusedfilter = f;
                    ...
                    f.attr("title", "");
                    f.keypress(function (evt) {
                        if (evt.keyCode === 13) {
                            getFilter(evt.target);
                        }
                    });
                ...
                case"input":
                    ...
                    var s = function(J, K, f) {
                        ...
                        I.blur(function() { I.removeClass(H.toThemeProperty("jqx-fill-state-focus")) });
                    ...
                    t.jqxDropDownList({ selectionRenderer: function(f) { return"" } });
                        ...
                        if (v) {
                            t.jqxDropDownList({
                                selectionRenderer: function() {
                                    var f = '<span class="' +
                                        H.toThemeProperty("jqx-item") +
                                        '" style="top: 2px; position: relative; color: inherit; border: none; background-color: transparent;">' +
                                        H.gridlocalization.filterselectstring +
                                        "</span>";
                                    return f
                                }
                            });
                ...
                case"boolean":
                    if (this.host.jqxCheckBox) {
                        var w =
                            a(
                                '<div tabIndex=0 style="opacity: 0.99; position: absolute; top: 50%; left: 50%; margin-top: -7px; margin-left: -10px;"></div>');
                        w.appendTo(d);
                        w.jqxCheckBox({
                            disabled: H.disabled,
                                ...
                                if (b.cellsformat) {
                                    ...
                                    for (var g = 0; g < f.length; g++) {
                                        ...
                                        if (j === "date") {
                                            if (h != null) {
                                                f[g][b.displayfield] =
                                                    dataadapter.formatDate(h, b.cellsformat, d.gridlocalization)
                                            } else {
                                                f[g][b.displayfield] = ""
                                            }
                                        } else {
                                            if (j === "number" || j === "float" || j === "int") {
                                                if (h != null) {
                                                    f[g][b.displayfield] =
                                                        dataadapter.formatNumber(h, b.cellsformat, d.gridlocalization)
                                                } else {
                                                    f[g][b.displayfield] = ""
                                                }
                                            }
                                        ...
                                        if (this.host.jqxDateTimeInput) {
                                            ...
                                            if (k != undefined) {
                                                ...
                                                if (c.filtertype == "range") {
                                                    a(f.children()[0])
                                                        .jqxDateTimeInput("setRange", new Date(k), new Date(g))
                                                } else {
                ...
                for (var p = 0; p < t; p++) {
                    ...
                    if (q.filterable) {
                        if (q.filtertype == "list" || q.filtertype == "checkedlist") {
                            ...
                            if (m) {
                                h.jqxDropDownList({
                                    selectionRenderer: function() { return v.gridlocalization.filterselectstring }
                                });
                                b.insertAt(this.gridlocalization.filterselectallstring, 0);
                                var n =
                                    a(
                                        '<span style="top: 2px; position: relative; color: inherit; border: none; background-color: transparent;">' +
                                        this.gridlocalization.filterselectstring +
                                        "</span>");
            ...
            applyfilters: function(f) {
                ...
                if (!this.groupable || (this.groupable && this.groups.length == 0)) {
                    ...
                    if (this.columns &&
                        ...
                        !this.columns.records[0].filtericon) {
            ...
            clearfilters: function(b) {
                ...
                if (this.columns.records) {
                    ...
                    a.each(this.columns.records, function() { d.removefilter(this.displayfield, !c) })
                }
                if (b === false) {
                    return
                }
            ...
            _updatefilterpanel: function(s, p, E) {
                ...
                if (this._hasdatefilter &&
                    (E.filtertype !== "list" && E.filtertype !== "checkedlist" && E.filtertype !== "custom")) {
                    var e = j.parent();
                    var d = h.parent();
                    e.children().remove();
                    d.children().remove();
                    if (E.filtertype == "date") {
                        ...
                        var b = a("<input class='filtertext1" +
                            s.element.id +
                            "' style='height: 20px; margin-top: 3px; margin-bottom: 3px;' type='text'></input>");
                        e.append(b);
                        var n = function(c) {
                        ...
                        n(b);
                        var b = a("<input class='filtertext2" +
                            s.element.id +
                            "' style='height: 20px; margin-top: 3px; margin-bottom: 3px;' type='text'></input>");
                        d.append(b);
                        n(b)
                ...
                if (this.filtermode === "default" &&
                    ...
                    if (!this._hasdatefilter || (this._hasdatefilter && E.filtertype != "date")) {
                        if (!this.touchdevice) {
                            j.focus();
                            setTimeout(function() { j.focus() }, 10)
                        }
                    }
                } else {
                                        ...
                                        function() {
                                            if (this.condition == "NOT_EQUAL") {
                                                if (G != this.value) {
                                                    ...
                                                    if (G != null &&
                                                        this.value != null &&
                                                        G.toString() != this.value.toString()) {
                                                        F.uncheckIndex(J, false, false);
                                                        return false
                                                    }
                                                }
            ...
            _initfilterpanel: function(z, b, c, p, w) {
                ...
                var h = a("<div class='filter filter2' id='filter2" +
                    z.element.id +
                    o +
                ...
                var k = a("<div class='filter'><input class='filtertext1" +
                    z.element.id +
                    "' style='height: 20px; margin-top: 3px; margin-bottom: 3px;' type='text'></input></div>");
                var m = k.find("input");
                ...
                m.width(p - 15);
                var l = a("<div class='filter'><input class='filtertext2" +
                    z.element.id +
                    "' style='height: 20px; margin-top: 3px;' type='text'></input></div>");
                var j = l.find("input");
                ...
                var f = a('<span tabIndex=0 id="filterbutton' +
                    z.element.id +
                    '" class="filterbutton" style="padding: 4px 12px; margin-left: 2px;">' +
                    z.gridlocalization.filterstring +
                    "</span>");
                g.append(f);
                var x = a('<span tabIndex=0 id="filterclearbutton' +
                    z.element.id +
                    '" class="filterclearbutton" style="padding: 4px 12px; margin-left: 5px;">' +
                    z.gridlocalization.filterclearstring +
                    "</span>");
                g.append(x);
