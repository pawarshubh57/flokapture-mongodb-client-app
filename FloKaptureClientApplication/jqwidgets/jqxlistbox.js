...
(function (a) {
    ...
    a.extend(a.jqx._jqxListBox.prototype, {
        ...
        createInstance: function (c) {
            ...
            b.render();
            var d = b;
            a.jqx.utilities.resize(b.host, function () { d._updateSize() }, false, b._checkForHiddenParent)
        },
        resize: function (c, b) {
            this.width = c;
            this.height = b;
            ...
            m.addHandler(m.filterInput, "keyup.textchange", function (o) {
                if (o.keyCode == 13) {
                    ...
                    if (m.filterDelay > 0) {
                        ...
                        m._filterTimer = setTimeout(function () { m._search(o) }, m.filterDelay)
                    }
                }
                o.stopPropagation()
            });
        ...
        propertyChangedHandler: function (b, c, e, d) {
            ...
            if (b._checkForHiddenParent && a.jqx.isHidden(b.host)) {
                a.jqx.utilities.resize(this.host, function () { b._updateSize() }, false, b._checkForHiddenParent)
            }
        },
        ...
        generatekey: function () {
            var b = function () { return (((1 + Math.random()) * 65536) | 0).toString(16).substring(1) };
            ...
            if (k.incrementalSearch) {
                ...
                if ((s >= 65 && s <= 97) || m || s == 8 || s == 32 || s == 46) {
                    ...
                    if (o >= 0) {
                        ...
                        k._toSelectTimer = setTimeout(function () { h() }, k.incrementalSearchKeyDownDelay)
                    }
                    i = true
                }
        ...
        _addHandlers: function () {
            ...
            this.addHandler(this.vScrollBar, "valueChanged", function (n) {
                if (a.jqx.browser.msie && a.jqx.browser.version > 9) {
                    setTimeout(function () { l._renderItems() }, 1)
                } else {
                    l._renderItems()
                }
            });
            ...
            if (this.enableSelection) {
                ...
                if (a.jqx.browser.msie) {
                    this.addHandler(this.content, "selectstart", function (n) { return false })
                }
            }
            var e = this.isTouchDevice();
