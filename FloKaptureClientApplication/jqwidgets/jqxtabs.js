    ...
    a.extend(a.jqx._jqxTabs.prototype,
        {
                ...
                if (this.rtl) {
                    if (this.scrollable && this._rightArrow && this._rightArrow.css("visibility") != "hidden") {
                        ...
                        var c = this.host.width() -
                            parseInt(this._unorderedList.width() +
                                d +
                                +parseInt(this._unorderedList.css("margin-left")),
                                10);
            ...
            _scrollRight: function(e, h) {
                ...
                var f = parseInt(this._unorderedList.width() + parseInt(this._unorderedList.css("margin-left")), 10),
                    ...
                    g,
                    j,
                    b = parseInt(this._unorderedList.css("left"), 10),
                ...
                if (parseInt(this._headerWrapper.width(), 10) >
                    parseInt(this._unorderedList.css("margin-left")) + parseInt(this._unorderedList.width(), 10)) {
                    d = c
                } else {
                    if (Math.abs(b) + this.scrollStep < Math.abs(i - f) + g + j + c) {
                        ...
                        if (d < parseInt(this._unorderedList.css("left"), 10) - 4 &&
                            d > parseInt(this._unorderedList.css("left"), 10) + 4) {
            ...
            _scrollLeft: function(f, g) {
                ...
                if (parseInt(this._headerWrapper.width()) >= parseInt(this._unorderedList.width())) {
                    ...
                    if (b + this.scrollStep < c) {
                        ...
                        e = c;
                        if (e < parseInt(this._unorderedList.css("left")) - 4 &&
                            e > parseInt(this._unorderedList.css("left")) + 4) {
            ...
            _performScrollAnimation: function(e, d, c) {
                ...
                this._unorderedList.animate({ left: e },
                    c,
                    function() {
            ...
            _addScrollHandlers: function() {
                var b = this;
                this.addHandler(this._leftArrow,
                    "mousedown",
                    function() { b._startScrollRepeat(true, b.scrollAnimationDuration) });
                this.addHandler(this._rightArrow,
                    "mousedown",
                    function() { b._startScrollRepeat(false, b.scrollAnimationDuration) });
            ...
            focus: function() {
                try {
                    this.host.focus();
                    var c = this;
                    setTimeout(function() { c.host.focus() }, 25)
                } catch (b) {
                }
            },
            _getFocusedItem: function(f, e) {
                ...
                while (i) {
                    ...
                    var h = this._titleList[i],
                        ...
                        b = d;
                    if ((b <= f && b + g >= f) &&
                        (h !== this._capturedElement) &&
                        (!this._titleList[i].locked) &&
                        (this._titleList[i].disabled !== true)) {
                        return i
                    }
                }
                return -1
            ...
            _uncapture: function(e) {
                ...
                a.each(this._titleList, function() { this.css("position", "static") });
            ...
            getSelectedItem: function() { return this.selectedItem },
            ...
            _moveElement: function(c, b) {
                ...
                if (b._tabCaptured) {
                    ...
                    if (!b._dragStarted) {
                        ...
                        if (c.clientX + unorderedListLeft > b._startX + 3 ||
                            c.clientX + unorderedListLeft < b._startX - 3) {
            ...
            _dragScroll: function(d) {
                ...
                if (d.clientX <= this._headerWrapper.offset().left) {
                    ...
                    this._capturedElement.css("left",
                        parseInt(this._capturedElement.css("left")) + this._lastUnorderedListPosition - c)
                } else {
                ...
                var b = this;
                this._scrollTimeout = setTimeout(function() { b._dragScroll(d) }, this.scrollAnimationDuration);
            ...
            _addSelectHandler: function(c) {
                var b = this;
                this.addHandler(this._titleList[c], "selectstart", function(d) { return false });
                this.addHandler(this._titleList[c],
                    this.toggleMode,
                    function(d) {
                        return function() {
            ...
            _moveSelectionTrack: function(l, c, b) {
                ...
                if (this.selectionTracker && this._selectionTracker) {
                    ...
                    var k = parseInt(this._titleList[l].css("padding-left")) +
                        parseInt(this._titleList[l].css("padding-right"));
                    var f = this.position == "top" ? 0 : 1;
                    var j = parseInt(this._headerWrapper.css("padding-top"));
                    var i = parseInt(this._titleList[l].css("padding-top")) +
                        parseInt(this._titleList[l].css("padding-bottom"));
            ...
            _startScrollRepeat: function(d, c) {
                ...
                this._scrollTimeout = setTimeout(function() { b._startScrollRepeat(d, b.scrollAnimationDuration) }, c)
            },
            ...
            updatetabsheader: function() { this._performHeaderLayout() },
            ...
            _addArrows: function() {
                ...
                this._leftArrow = a('<div><span style="display: block; width: 16px; height: 16px;" class="' +
                    this.toThemeProperty("jqx-tabs-arrow-left") +
                    '"></span></div>');
                this._rightArrow = a('<div><span style="display: block; width: 16px; height: 16px;" class="' +
                    this.toThemeProperty("jqx-tabs-arrow-right") +
                    '"></span></div>');
            ...
            _calculateTitlesSize: function() {
                ...
                while (c) {
                    ...
                    this._titleList[c].find(this.toThemeProperty(".jqx-tabs-close-button", true))
                        .css("display", "none");
                    ...
                    if (b != undefined && b != null) {
                        ...
                        if (this.showCloseButtons &&
                            (this.canCloseAllTabs || this._tabsWithVisibleCloseButtons() > 1)) {
                            var e = false;
                            if (this.hiddenCloseButtons) {
                                if (this.hiddenCloseButtons[c] == 1) {
                                    this._titleList[c].find(this.toThemeProperty(".jqx-tabs-close-button", true))
            ...
            _verticalAlignElements: function() {
                ...
                while (k) {
                    ...
                    if (this.autoHeight) {
                        ...
                        if (this.position === "top") {
                            var i = parseInt(this._unorderedList.height()) -
                                parseInt(this._titleList[k].outerHeight(true));
            ...
            _addSelectionTracker: function() {
                ...
                this._moveSelectionTrackerContainer = a('<div class="' +
                    this.toThemeProperty("jqx-tabs-selection-tracker-container") +
                    '">');
            ...
            _addContentWrapper: function() {
                ...
                this._contentWrapper = this._contentWrapper ||
                    a('<div class="' + this.toThemeProperty("jqx-tabs-content") + '" style="float:' + d + ';">');
            ...
            _addHeaderWrappers: function() {
                ...
                this._headerWrapper = this._headerWrapper ||
                    a('<div class="jqx-tabs-headerWrapper" style="outline: none;">');
            ...
            _addCloseButton: function(c) {
                var f = c;
                if (this._titleList[f].find(this.toThemeProperty(".jqx-tabs-close-button", true)).length <= 0 &&
                    this._titleList[f].find(".jqx-tabs-titleContentWrapper").length <= 0) {
            ...
            _isValidIndex: function(b) { return(b >= 0 && b < this.length()) },
            _removeSelectStyle: function() {
                ...
                while (c) {
                    ...
                    var b = null;
                    if (this.showCloseButtons) {
                        var b = this._titleList[c].children(0)
                            .children(this.toThemeProperty(".jqx-tabs-close-button", true));
            ...
            removeAt: function(d) {
                if (this._isValidIndex(d) && (this.canCloseAllTabs || this.length() > 1)) {
                    ...
                    if (parseInt(this._unorderedList.width()) <= parseInt(this._headerWrapper.width())) {
                        ...
                        this._lockAnimation("unorderedList");
                        this._unorderedList.animate({ left: 0 }, f, function() { b._unlockAnimation("unorderedList") })
                    }
                }
            },
            removeFirst: function() { this.removeAt(0) },
            removeLast: function() { this.removeAt(this.length() - 1) },
            ...
            addFirst: function(c, b) { this.addAt(0, c, b) },
            addLast: function(c, b) { this.addAt(this.length(), c, b) },
            val: function(b) {
            ...
            length: function() { return this._titleList.length },
            lockAt: function(b) {
            ...
            ensureVisible: function(d) {
                ...
                this._lockAnimation("unorderedList");
                this._unorderedList.animate({ left: g },
            ...
            isDisabled: function(b) { return this._titleList[b].disabled },
