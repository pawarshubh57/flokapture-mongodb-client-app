...
!function ($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                button: '<button type="button" class="multiselect dropdown-toggle" style="width: 317px;"  data-toggle="dropdown"></button>',
                ul: '<ul class="multiselect-container dropdown-menu" style="width: 317px;"></ul>',
