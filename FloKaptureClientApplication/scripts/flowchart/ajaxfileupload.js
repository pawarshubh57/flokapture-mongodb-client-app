jQuery.extend({
    ...
    createUploadForm: function (id, fileElementId, data) {
        ...
        var form = jQuery('<form  action="" method="POST" name="' +
            formId + '" id="' + formId + '" enctype="multipart/form-data"></form>');
        if (data) {
            for (var i in data) {
    ...
    ajaxFileUpload: function (s) {
        ...
        var uploadCallback = function (isTimeout) {
            ...
            try {
                ...
                jQuery.handleError(s, xml, null, e1);
            }
            if (xml || isTimeout === "timeout") {
                ...
                try {
                    ...
                    console.log(err);
                    status = "error";
                    alert("File format is not correct. Please upload file with .csv extension only");
                }
                ...
                setTimeout(function () {
                    try {
                        ...
                        jQuery.handleError(s, xml, null, error);
                    }
                }, 100);
                xml = null;
            }
