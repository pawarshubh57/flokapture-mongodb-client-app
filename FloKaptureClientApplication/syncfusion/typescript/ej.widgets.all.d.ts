...
interface RibbonOptions {
    width?: (number|string);
    buttonDefaults?: RibbonButtonDefaults;
    expandPinSettings?: RibbonExpandPinSettings;
    collapsePinSettings?: RibbonCollapsePinSettings;
...
interface RibbonTabGroup {
    ...
    groupExpanderSettings?: RibbonGroupExpanderSettings;
...
interface RibbonExpandPinSettings {
    toolTip?: string;
    customToolTip?: CustomToolTip;
}
interface RibbonButtonDefaults {
    width?: (number|string);
    height?: (number|string);
    enableRTL?: boolean;
    showRoundedCorner?: boolean;
...
interface RibbonCollapsePinSettings {
    toolTip?: string;
    customToolTip?: CustomToolTip;
}
interface RibbonGroupExpanderSettings {
    toolTip?: string;
    customToolTip?: CustomToolTip;
}
...
enum PagerPosition
{
 ...
 class Grid extends ej.Widget {
    ...
    interface StackedHeaderColumns {
        column?: string;
        cssClass?: string;
        headerText?: string;
        textAlign?: (ej.TextAlign | string);
    }
    interface StackedHeaderRows {
        stackedHeaderColumns?: Array<StackedHeaderColumns>;
    }
    ...
    interface GridSortSettings {
 	...
 	interface GridTextWrapSettings {
     	wrapMode?: ej.Grid.WrapMode;
 	}
